...
import { FormMontagemComponent } from './montagem/form-montagem/form-montagem.component';
import { ListaMontagemComponent } from './montagem/lista-montagem/lista-montagem.component';
...
@NgModule({
  declarations: [
    ...
    FormMontagemComponent,
    ListaMontagemComponent,
    FormBolosComponent,
    ListBolosComponent,
    FormItensComponent,
    ListaItensComponent
