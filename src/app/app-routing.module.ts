...
import { ListBolosComponent } from './bolos-montagem/list-bolos/list-bolos.component';
import { FormBolosComponent } from './bolos-montagem/form-bolos/form-bolos.component';
import { ListaItensComponent } from './bolos/lista-itens/lista-itens.component';
import { FormItensComponent } from './bolos/form-itens/form-itens.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'bolos-montagem', component: ListBolosComponent },
      { path: 'bolos-montagem/novo', component: FormBolosComponent },
      { path: 'bolos-montagem/editar/:key', component: FormBolosComponent },
      { path: 'bolos', component: ListaItensComponent },
      { path: 'bolos/novo', component: FormItensComponent},
      { path: 'bolos/editar/:key', component: FormItensComponent},
